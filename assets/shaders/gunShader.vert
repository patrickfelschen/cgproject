...
void main() {
    ...
    */
    ...
    /*
        ...
        Vertex Position mit der Projektions- und Modeltransformations-Matrix in CLIP SPACE transformieren.
        LOCAL SPACE -> [MODEL MATRIX] -> WORLD SPACE -> [VIEW MATRIX] -> VIEW SPACE -> [PROJECTION MATRIX] ->
        CLIP SPACE -> [VIEWPORT] -> SCREEN SPACE
        Die View-Matrix wird bei der Waffe vernachlässigt, damit diese statisch an der Camera "hängt"
    */
